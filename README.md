Machine learning-based prediction of COVID-19 diagnosis based on symptoms (Use google-colab for seeing all the visual graphs. Since, I have used Plotly.express for plotting the graphs in the EDA part)
